...
excerpt: Java in-memory database. Running SQL queries on a CSV file.
---
...
That is almost everything, but if you want to see everything, [download the Database class file](/assets/2015.07/Database.java).
